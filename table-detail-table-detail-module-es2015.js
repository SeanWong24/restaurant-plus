...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TableDetailPageRoutingModule", function() { return TableDetailPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _table_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./table-detail.page */ "./src/app/table/table-detail/table-detail.page.ts");
...
TableDetailPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _table_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./table-detail-routing.module */ "./src/app/table/table-detail/table-detail-routing.module.ts");
/* harmony import */ var _table_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./table-detail.page */ "./src/app/table/table-detail/table-detail.page.ts");
...
TableDetailPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _table_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__["TableDetailPageRoutingModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TableDetailPage", function() { return TableDetailPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let TableDetailPage = class TableDetailPage {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.table.name && this.table.name !== 'null' && this.table.capacity >= 0) {
                if (this.isCreatingNewTable) {
                    const response = yield fetch(localStorage.getItem('serverApiBaseUrl') + '/table/add?name=' + this.table.name + '&capacity=' + this.table.capacity, { method: 'POST' });
                    if (response.ok) {
                    ...
                    const response = yield fetch(localStorage.getItem('serverApiBaseUrl') + '/table/modify?id=' + this.table.id + '&name=' + this.table.name + '&capacity=' + this.table.capacity, { method: 'PUT' });
                    if (response.ok) {
                        this.navController.navigateBack('/table');
                    }
                    else {
    ...
    toggleAvailability() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const response = yield fetch(localStorage.getItem('serverApiBaseUrl') + '/table/toggle-availability?id=' + this.table.id, { method: 'PUT' });
            if (response.ok) {
                this.navController.navigateBack('/table');
            }
            else {
...
TableDetailPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-table-detail',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./table-detail.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/table/table-detail/table-detail.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./table-detail.page.scss */ "./src/app/table/table-detail/table-detail.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"]])
], TableDetailPage);
...
//# sourceMappingURL=table-detail-table-detail-module-es2015.js.map