(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["table-table-module"], {
  ...
  function srcAppTableTableRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [{
      ...
      /*! import() | table-detail-table-detail-module */
      "table-detail-table-detail-module").then(__webpack_require__.bind(null,
      /*! ./table-detail/table-detail.module */
      "./src/app/table/table-detail/table-detail.module.ts")).then(m => m.TableDetailPageModule)
    }];
  ...
  function srcAppTableTablePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../models/table */
    "./src/app/models/table.ts");
    /* harmony import */
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"]])], TablePage);
